...
def interpolate_diff(image_paths: list[str], output: str="", step: float=0.05, mult: float=4, bpm: float=140):
...
if __name__ == "__main__":
  ...
  interpolate_diff(image_paths=args.images, output=args.output, step=args.step, mult=args.mult, bpm=args.bpm)
