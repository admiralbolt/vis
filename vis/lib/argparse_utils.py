...
def add_subparsers(parser: argparse.ArgumentParser):
  ...
  canny_edge_parser = filter_parser.add_parser("canny_edge", conflict_handler="resolve")
  canny_edge_parser.add_argument("--lower_threshold", type=int, default=50, help="Lower threshold for canny edges.")
  canny_edge_parser.add_argument("--upper_threshold", type=int, default=100, help="Upper threshold for canny edges.")
  canny_edge_parser.add_argument("--r", type=int, default=None, help="R value for edge.")
  canny_edge_parser.add_argument("--g", type=int, default=None, help="G value for edge.")
  canny_edge_parser.add_argument("--b", type=int, default=None, help="B value for edge.")
...
def call_with_args(args: dict):
  return {
    ...
    "canny_edge": partial(image_utils.get_canny_edges,
